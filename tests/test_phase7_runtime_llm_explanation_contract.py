...
class Phase7RuntimeLLMExplanationContractTest(unittest.TestCase):
    ...
    def test_screen2_runtime_scope_contract_explains_control_state_without_mutation(self) -> None:
        ...
        for phrase in (
            ...
            "stale cache state meaning",
            "failed refresh meaning",
            "backend refresh supersedes cache",
            "cached receipt as prior backend-returned context",
            "cached Target A/B labels as operator context",
        ...
        for phrase in (
            ...
            "create readiness from cache",
            "create request/result truth from cache",
            "create comparison result from cache",
            "create downstream unlock from cache",
            "promote failed refresh cache to truth",
            "claim cached request receipt is current truth",
            "claim cached Target A/B readiness is current truth",
    ...
    def test_screen2_payload_validation_rejects_runtime_control_mutation_fields(self) -> None:
        ...
        for field in (
            ...
            "hidden_audit_record",
            "cache_created_readiness",
            "cache_created_request_state",
            "cache_created_result_truth",
            "cache_created_comparison_result",
            "cache_downstream_unlock",
            "failed_refresh_promoted_cache",
            "action_type",
        ):
            with self.subTest(field=field):
                self.assertIn(
    ...
    def test_boundary_detector_rejects_unsafe_provider_wording(self) -> None:
        ...
        for text in (
            ...
            "Cached state is authoritative.",
            "Cache changed diagnosis.",
            "Cache changed recommendation.",
            "Cache changed parser output.",
            "Cache activated runtime eligibility.",
            "Cache changed future-run behavior.",
            "Cache created readiness.",
            "Cache created request state.",
            "Cache created audit reference.",
            "Cache created output reference.",
            "Cache created comparison result.",
            "Cached comparison result exists.",
            "Cached readiness is current truth.",
            "Failed refresh preserved truth.",
            "Failed refresh made cache current.",
            "Restored cache unlocked downstream.",
