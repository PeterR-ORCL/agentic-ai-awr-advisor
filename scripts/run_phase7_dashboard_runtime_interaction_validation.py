...
def validate_screens3_6_runtime_explanation_copy(
    ...
    required_by_path = {
        ...
        "awr_dashboard/screen_4_historical_review.html": (
            ...
            "Page identity, route state, cache/localStorage, prepared Target A/B alone, LLM text, scalar/min/max-only values, repeated shared samples, and synthetic/default rows cannot select visuals",
...
def validate_index_source_selection_behavior_contract(
    ...
    required_source_markers = (
        ...
        "source_type: dashboardState.selectedSourceMode",
        "source_channel: dashboardState.selectedSourceMode",
        "sourceSelectionSessionId: dashboardState.sourceSelectionSessionId",
        "browser_truth_boundary",
...
def validate_generated_default_evidence_gating(
    ...
    downstream_expectations = {
        ...
        "awr_dashboard/screen_4_historical_review.html": (
            ...
            ("Evidence Review / Historical Supporting Context", "Evidence Review Modes", "Historical Context Summary", "Anomaly Burden", "SPRTRN / 8101005004"),
        ),
        "awr_dashboard/screen_5_recommendation_action.html": (
