...
--
-- Edit the DEFINE values below or override them before running:
--   DEFINE DB_NAME='FINDB'
--   @scope_validation_queries.sql
--------------------------------------------------------------------------------
...
prompt ============================================================
prompt 2. Database-wide metric history
prompt ============================================================
...
prompt ============================================================
prompt 3. Host-specific metric history
prompt ============================================================
...
prompt ============================================================
prompt 4. Instance-specific metric history
prompt ============================================================
...
prompt ============================================================
prompt 5. RAC instance comparison
prompt ============================================================
...
where db_name = '&DB_NAME'
  and snap_begin_time >= to_timestamp('&START_TIME', 'YYYY-MM-DD HH24:MI:SS')
  and snap_end_time   <= to_timestamp('&END_TIME', 'YYYY-MM-DD HH24:MI:SS')
  and metric_name in ('DB_CPU_PCT', 'CLUSTER_WAIT_PCT_DB_TIME')
order by snap_begin_time, instance_number, metric_name;
...
prompt ============================================================
prompt 8. Canonical feature history by scope
prompt ============================================================
...
where db_name = '&DB_NAME'
  and snap_begin_time >= to_timestamp('&START_TIME', 'YYYY-MM-DD HH24:MI:SS')
  and snap_end_time   <= to_timestamp('&END_TIME', 'YYYY-MM-DD HH24:MI:SS')
order by snap_begin_time, feature_vector_id;

prompt ============================================================
prompt 9. Canonical score history by scope
prompt ============================================================
...
where db_name = '&DB_NAME'
  and snap_begin_time >= to_timestamp('&START_TIME', 'YYYY-MM-DD HH24:MI:SS')
  and snap_end_time   <= to_timestamp('&END_TIME', 'YYYY-MM-DD HH24:MI:SS')
order by snap_begin_time, score_result_id;

prompt ============================================================
prompt 10. CPU_UTIL_P95 history by DB
prompt ============================================================
...
prompt ============================================================
prompt 11. CPU_UTIL_P95 history by host context
prompt ============================================================
...
prompt ============================================================
prompt 12. CPU_UTIL_P95 history by instance context
prompt ============================================================
...
prompt ============================================================
prompt 13. RAC and GC engineered metric history
prompt ============================================================
...
prompt ============================================================
prompt 14. Exadata engineered metric history
prompt ============================================================
...
prompt ============================================================
prompt 15. Feature-scope duplicate row check
prompt Expect zero rows after ddlv6
prompt ============================================================
...
prompt ============================================================
prompt 16. Engineered feature metric duplicate row check
prompt Expect zero rows after ddlv6
prompt ============================================================
...
prompt ============================================================
prompt 17. Score-scope duplicate row check
prompt Expect zero rows after ddlv6 for canonical score history
prompt ============================================================
...
prompt ============================================================
prompt 18. Raw logical duplicate reports in AWR_REPORT
prompt Historical duplicates may still appear here; ddlv6 canonicalizes them
prompt ============================================================
...
prompt ============================================================
prompt 19. Exact duplicate file hash check
prompt ============================================================
...
prompt ============================================================
prompt 20. Duplicate-ingest guardrail verification (exact hash)
prompt ============================================================
...
prompt ============================================================
prompt 21. Duplicate-ingest guardrail verification (logical snapshot identity)
prompt ============================================================
...
prompt ============================================================
prompt 22. Chosen engineered metric history
prompt ============================================================
